export const initialContext = {
    ...
    constants: {
        ...
        steps: {
            ...
            option2: {
                type: "textOption",
                question:{text:["Bad data: Th1s syst3m is n0w 0urs. Ar3 you w1th 0r w1th0ut us?\n","Answer!"],questionStyle:{fill:0xdc1111}},
                options: [
                    {text:"With, of course. I have no intention of fighting more worms. There is no point. I quit.",goTo:["textGiveUp"]},
